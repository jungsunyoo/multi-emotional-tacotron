# Multi-emotion text-to-speech (TTS) algorithm using Tensorflow

This is a TensorFlow implementation of [Emotional End-to-End Neural Speech Synthesizer](https://arxiv.org/abs/1711.05447)
This code is heavily based on [Multi-speaker-tacotron](https://github.com/carpedm20/multi-speaker-tacotron-tensorflow) by carpedm20.
...
To train a single-emotion model:

    python3 train_tacotron.py --data_path=datasets/son
    python3 train_tacotron.py --data_path=datasets/son --initialize_path=PATH_TO_CHECKPOINT

To train a multi-emotion model:

    # after change `model_type` in `hparams.py` to `deepvoice` or `simple`
    python3 train_tacotron.py --data_path=datasets/angry,datasets/sad

To restart a training from previous experiments such as `logs/son-20171015`:

    python3 train_tacotron.py --data_path=datasets/son --load_path logs/son-20171015
